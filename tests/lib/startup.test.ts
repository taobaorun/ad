...
describe('startup surface helpers', () => {
  ...
  it('removes the blocking splash and exposes an actionable startup failure', () => {
    document.body.innerHTML = `
    ...
    expect(document.getElementById('root')).toHaveClass('ad-app-enter');
    expect(screen.getByRole('alert')).toHaveTextContent('AD 无法启动');
