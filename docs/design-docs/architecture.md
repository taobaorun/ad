...
| Git Skill source generations / stable view | `~/.ad/skill-library/<readable-source-name>--<short-id>/generations/`、`current`；兼容 legacy SHA-256 root |
