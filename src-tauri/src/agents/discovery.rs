...
impl InstallationCandidate {
    ...
    pub(crate) fn with_project_path(mut self, project_path: impl Into<String>) -> Self {
        self.installation.project_path = Some(project_path.into());
        self
    }

    pub(crate) fn with_base_installation_id(mut self, installation_id: InstallationId) -> Self {
        self.installation.base_installation_id = Some(installation_id);
        self
    }
