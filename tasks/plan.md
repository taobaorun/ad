...
- [ ] **待用户确认** — 评审 HTML 路径：docs/exec-plans/active/multi-agent-support.html
- [ ] 用户已确认，开始执行（时间戳）
...
- [ ] (待批准) 评审多 Agent 产品规格和本 ExecPlan
- [ ] (待开始) 建立 agent-neutral model、registry、capability 和 schema migration
